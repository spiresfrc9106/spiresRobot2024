...
class GamePieceCtrl:
    def __init__(self):
        ...
        self.transferL1.setPID(0.00005, 0, 0)
        self.transferL1.setVoltage(12)
        #self.transferL1.setInverted(False)
        # transferL2
        self.transferL2 = WrapperedSparkMax(self.TRANSFER_L2_CANID, "TransferL2")
        self.transferL2.setPID(0.00005, 0, 0)
        self.transferL2.setVoltage(12)
        self.transferL2.setVelCmd(1)
